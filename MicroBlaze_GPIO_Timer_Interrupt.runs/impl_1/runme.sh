...
HD_PWD='D:/FPGA/MicroBlaze_GPIO_Timer_Interrupt/MicroBlaze_GPIO_Timer_Interrupt.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_Timer_Interrupt_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_Timer_Interrupt_wrapper.tcl -notrace
