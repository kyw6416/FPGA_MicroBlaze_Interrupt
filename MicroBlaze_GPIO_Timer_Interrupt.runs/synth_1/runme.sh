...
HD_PWD='D:/FPGA/MicroBlaze_GPIO_Timer_Interrupt/MicroBlaze_GPIO_Timer_Interrupt.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_Timer_Interrupt_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_Timer_Interrupt_wrapper.tcl
