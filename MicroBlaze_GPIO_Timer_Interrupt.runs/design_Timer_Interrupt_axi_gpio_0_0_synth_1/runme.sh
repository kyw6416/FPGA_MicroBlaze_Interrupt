...
HD_PWD='D:/FPGA/MicroBlaze_GPIO_Timer_Interrupt/MicroBlaze_GPIO_Timer_Interrupt.runs/design_Timer_Interrupt_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_Timer_Interrupt_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_Timer_Interrupt_axi_gpio_0_0.tcl
